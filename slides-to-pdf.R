...
#
# Usage:
#   ./slides-to-pdf.R                    # update every out-of-date deck
#   ./slides-to-pdf.R 07-wrangling-data  # convert just one deck, forced
#   ./slides-to-pdf.R --force            # reconvert everything
#   ./slides-to-pdf.R --help
