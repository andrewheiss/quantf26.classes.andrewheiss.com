...
Use `summarise()` to compute four statistics about the data:
...
Use `filter()` and `summarise()` to calculate the (1) the number of unique countries and (2) the median life expectancy on the African continent in 2007.
