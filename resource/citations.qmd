...
You can access [a shared group Zotero library of all the non-web-based class reading references](https://www.zotero.org/groups/quantf26-guq) and link it to your Zotero account to easily cite the course materials. 
...
<a class="btn btn-danger" target="_blank" href="https://www.zotero.org/groups/quantf26-guq">{{< ai zotero color=white >}}&ensp;Zotero group library</a> &ensp;
<a class="btn btn-danger" target="_blank" href="/files/bib/readings.bib" role="button">{{< fa book >}}&ensp;BibTeX file</a>
</p>

---

You can use these references in your Quarto documents directly in Positron! You need to set up a few things first, but then it's straightforward to get automatic citations in your documents. You can also see [the official Quarto documentation for citations](https://quarto.org/docs/authoring/citations.html) in general and the [Positron documentation](https://Positron.github.io/visual-markdown-editing/citations.html) (and [this blog post](https://posit.co/blog/Positron-1-4-preview-citations/)) for working with citations in Positron.

## Initial set up

Before Positron can look at and use your Zotero library, you need to do two things first. **You only need to do this setup once.**
