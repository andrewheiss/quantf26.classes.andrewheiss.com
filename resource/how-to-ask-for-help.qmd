...
You will get stuck this semester. It is inevitable. **It is normal.**
...
While you can theoretically do that here (and some students to), **I do not recommend it**.
...
You can also take screenshots to *supplement* your question (use ⌘+shift+4 on macOS to save a screenshot to your Desktop, or ⌘+⌥+shift+4 to save a screenshot directly to the clipboard; use Windows+shift+S on Windows to save a screenshot directly to the clipboard). **Do not send a screenshot as your entire question though** (it's very tempting to just post a picture of an error and hope that someone can fix it)—provide context. Screenshots are helpful, but code/text is better—it's harder for people to get the code out of a screenshot in Discord and into Positron on their computer to troubleshoot, since you can't copy/paste from an image.
...
**Person A:** I'm stuck on Problem Set X
...
**Person B:** Ah cool, that's an easy fix! That just means that you don't have the tidyverse library installed on your computer. You can fix it by either using the Packages pane in Positron to install it, or run this in your console:
...
You can meet with me for [student hours](/syllabus.qmd#student-hours) by signing up for an appointment [at my scheduling page](https://calendly.com/andrewheiss/). The link is also accessible at the [top of the syllabus page](/syllabus.qmd) and on [the main homepage](/) of the class site.
