...
Because there are so many possible colors, I use code to generate the `color: ` section of `_brand.yml` and manually copy/paste it into my official `_brand.yml` file.
...
cat(
  "<details><summary>_brand.yml color section</summary>\n\n",
  "```yaml\n", brand_yaml, "\n```\n\n",
  "</details>",
  sep = ""
)
